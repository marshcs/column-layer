...
#
# Generated by export_simulation on Tue Sep 05 17:06:30 +0800 2017
#
################################################################################
...
switch to the './mem_v2c_sign.sh' script.

./mem_v2c_sign.sh -reset_run
...
./mem_v2c_sign.sh -noclean_files

For more information on the script, please type './mem_v2c_sign.sh -help'.
